...
Func ReadConfig_MOD()
	...
	; Auto Dock, Hide Emulator & Bot - Demen MOD (#-07)
	...
	; Check Collector Outside - Demen MOD (#-08)
	...
	; ExtendedAttackBar - Demen MOD (#-22)
	...
	; Check Grand Warden Mode - Demen MOD (#-26)
	...
	; Switch Accounts - Demen MOD (#-12)
	ReadConfig_SwitchAcc()

	; Farm Schedule - Demen MOD (#-27)
	If $g_iCmbSwitchAcc Then
		Local $sSwitchAccFile = $g_sProfilePath & "\SwitchAccount.0" & $g_iCmbSwitchAcc & ".ini"
		For $i = 0 To 7
			IniReadS($g_abChkSetFarm[$i], $sSwitchAccFile, "FarmStrategy", "ChkSetFarm" & $i, False, "Bool")

			IniReadS($g_aiCmbAction1[$i], $sSwitchAccFile, "FarmStrategy", "CmbAction1" & $i, 0, "Int")
			IniReadS($g_aiCmbCriteria1[$i], $sSwitchAccFile, "FarmStrategy", "CmbCriteria1" & $i, 0, "Int")
			IniReadS($g_aiTxtResource1[$i], $sSwitchAccFile, "FarmStrategy", "TxtResource1" & $i, "")
			IniReadS($g_aiCmbTime1[$i], $sSwitchAccFile, "FarmStrategy", "CmbTime1" & $i, -1, "Int")

			IniReadS($g_aiCmbAction2[$i], $sSwitchAccFile, "FarmStrategy", "CmbAction2" & $i, 0, "Int")
			IniReadS($g_aiCmbCriteria2[$i], $sSwitchAccFile, "FarmStrategy", "CmbCriteria2" & $i, 0, "Int")
			IniReadS($g_aiTxtResource2[$i], $sSwitchAccFile, "FarmStrategy", "TxtResource2" & $i, "")
			IniReadS($g_aiCmbTime2[$i], $sSwitchAccFile, "FarmStrategy", "CmbTime2" & $i, -1, "Int")
		Next
	EndIf

	; Restart Search Legend league - Demen MOD (#-29)
	...
	; Stop on Low battery - Demen MOD (#-30)
