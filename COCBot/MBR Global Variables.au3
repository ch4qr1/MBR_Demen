...
Global Enum $eIcnArcher = 1, $eIcnDonArcher, $eIcnBalloon, $eIcnDonBalloon, $eIcnBarbarian, $eIcnDonBarbarian, $eBtnTest, $eIcnBuilder, $eIcnCC, $eIcnGUI, _
		...
		$eIcnUpgrade, $eIcnDebug, $eIcnMods, $eIcnSwitchOptions, $eIcnHumanization, $eIcnGoblinXP, $eIcnChatbot, $eIcnStats, $eIcnSwitchAcc, $eIcnSwitchProfiles, $eIcnFarmSchedule, _ ; Icn For Mods Tab
...
#include "Demen_MOD\Globals_Demen_MOD.au3"
