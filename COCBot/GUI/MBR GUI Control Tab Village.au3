...
Func chkRequestCCHours()
	...
	If GUICtrlRead($g_hChkRequestTroopsEnable) = $GUI_CHECKED Then
		...
		For $i = $chkReqCCFirst To $g_hLblRequestCCHoursPM ; CheckCC Troops
			GUICtrlSetState($i, $GUI_ENABLE)
		Next
	Else
		GUICtrlSetState($g_hTxtRequestCC, $GUI_SHOW + $GUI_DISABLE)
		GUICtrlSetState($g_hChkTroopsCC, $GUI_UNCHECKED) ; CheckCC Troops
		GUIControlCheckCC() ; CheckCC Troops
