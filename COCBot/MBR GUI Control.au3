...
#include "Demen_MOD\GUI\MOD GUI Control.au3"
...
; Showing troops time in MultiStats - Switch Accounts
...
Func tabMod()
	...
	Select
		...
		Case $tabidx = 5 ; Warpreparation tab
			GUISetState(@SW_HIDE, $g_hGUI_MOD_PROFILES)
		Case Else
			GUISetState(@SW_HIDE, $g_hGUI_MOD_PROFILES)
	EndSelect
...
Func Bind_ImageList($nCtrl, ByRef $hImageList)
	...
	Switch $nCtrl
		...
		Case $g_hGUI_MOD_TAB
			...
			Local $aIconIndex = [$eIcnSwitchOptions, $eIcnHumanization, $eIcnGoblinXP, $eIcnChatbot, $eIcnStats]
